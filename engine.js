...
// 1. حقن الواجهة الأصلية والأزرار بالكامل
...
let currentTargetNodeIndex = 1;
let actionWaitTimer = 0;
let actualPathPoints3D = [];
let parsedPathData = [];
...
let currentCharNum = 5; 
let targetObjRotation = 0; 
